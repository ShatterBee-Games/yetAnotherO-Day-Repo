    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void Update()
        {
            ...
            if (reloadTimer > 0f)
            {
                ...
                {
                    Debug.LogError("bulletCounter component not found!");
                }
            }
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(
                transform.position + _characterBounds.center,
                _characterBounds.size
            );
            ...
            if (!Application.isPlaying)
            {
                ...
                foreach (
                    var range in new List<RayRange> { _raysUp, _raysRight, _raysDown, _raysLeft }
                )
                {
        ...
        [Header("WALKING")]
        [SerializeField]
        private float _acceleration = 70;

        [SerializeField]
        private float _moveClamp = 13;

        [SerializeField]
        private float _deAcceleration = 50f;
        ...
        [SerializeField]
        private float _minFallSpeed = 73f;

        [SerializeField]
        private float _maxFallSpeed = 90f;
        ...
        private void CalculateGravity()
        {
            ...
            else
            {
                ...
                var fallSpeed =
                    _endedJumpEarly && _currentVerticalSpeed > 0
        ...
        private bool CanUseCoyote =>
            _coyoteUsable && !_colDown && _timeLeftGrounded + _coyoteTimeThreshold > Time.time;
